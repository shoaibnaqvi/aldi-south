  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <div class="fadeIn first pt-5">
        <img
          src="https://www.freelogoservices.com/api/main/images/1j+ojVVCOMkX9Wyrexe4hGfq1qnR9UVZxBzAwWIyPj1B9AxolSAshvJ9sKNia1hV7FANghwOdsY0jSBtAN5K0lM4oHrONIo="
          id="icon" alt="User Icon"/>
      </div>

      <!-- Login Form -->
      <form class="pt-5" @submit="registerUser">
        ...
        <input type="text" id="confirmPassword" class="fadeIn third" name="confirmPassword"
               placeholder="confirmPassword" v-model="confirmPassword">
        <input type="submit" class="fadeIn fourth" value="Log In" v-on:click="loginUser()">
      </form>
  ...
  methods: {
    registerUser: function (e) {
      ...
      if (!this.confirmPassword) {
        this.errors.push('Confirm the password again.')
      }

      if (!this.confirmPassword !== this.password) {
        this.errors.push('Passwords did\'nt match.')
      }
